...
from trl.trainer.ppov2_trainer import (Accelerator, CallbackHandler, DEFAULT_CALLBACKS, DEFAULT_PROGRESS_CALLBACK, DataCollatorWithPadding, DataLoader, Dataset, Dict, ExportableState, F, GenerationConfig, INVALID_LOGPROB, List, OnlineTrainerState, Optional, PPOv2Config, PPOv2Trainer, PolicyAndValueWrapper, PreTrainedTokenizer, PrinterCallback, Trainer, TrainerCallback, TrainerControl, Tuple, Union, batch_generation, broadcast, defaultdict, disable_dropout_in_model, exact_div, first_true_indices, forward, gather_object, gc, get_reporting_integration_callbacks, get_reward, masked_mean, masked_whiten, math, nn, np, os, pd, prepare_deepspeed, print_rich_table, time, torch, trl_sanitze_kwargs_for_tagging, truncate_response, unwrap_model_for_generation, wraps)
...
class _UnslothPPOv2Trainer(Trainer):
    _tag_names = ["trl", "ppo"]
