...
from trl.trainer.xpo_trainer import (Any, Callable, Dataset, Dict, EvalPrediction, F, IterableDataset, List, OnlineDPOTrainer, OptimizerNames, Optional, PreTrainedModel, PreTrainedTokenizerBase, TrainerCallback, Tuple, Union, XPOConfig, XPOTrainer, empty_cache, get_reward, nn, torch, truncate_right, unwrap_model_for_generation)
