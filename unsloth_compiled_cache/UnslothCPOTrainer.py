...
from trl.trainer.cpo_trainer import (Any, AutoModelForCausalLM, CPOConfig, CPOTrainer, Callable, DPODataCollatorWithPadding, DataCollator, DataLoader, Dataset, Dict, EvalLoopOutput, F, List, Literal, Optional, PartialState, PeftModel, PreTrainedModel, PreTrainedTokenizerBase, Trainer, TrainerCallback, Tuple, Union, add_bos_token_if_needed, add_eos_token_if_needed, amp, defaultdict, disable_dropout_in_model, inspect, is_peft_available, is_torch_fx_proxy, is_wandb_available, nn, np, nullcontext, pad_to_length, peft_module_casting_to_bf16, prepare_model_for_kbit_training, random, torch, trl_sanitze_kwargs_for_tagging, wandb, warnings, wraps)
