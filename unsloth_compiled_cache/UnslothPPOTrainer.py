...
class UnslothPPOConfig(PPOConfig):
    ...
    def __init__(
        self,
        exp_name = 'main_self_reward_param_copy',
        seed = 3407,
        log_with = None,
        task_name = None,
        model_name = 'gpt2',
